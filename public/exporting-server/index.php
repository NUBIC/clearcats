...
// Options
define ('BATIK_PATH', '/Users/paulfriedman/work/clearcats/public/exporting-server/batik-rasterizer.jar');
...
if ($typeString) {
	...
	shell_exec("chmod 777 temp/$tempName.svg");
	// do the conversion
	$output = shell_exec("java -jar -Djava.awt.headless=true ". BATIK_PATH ." $typeString -d $outfile $width temp/$tempName.svg");
